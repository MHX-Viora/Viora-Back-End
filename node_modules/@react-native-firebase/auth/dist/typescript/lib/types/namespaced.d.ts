...
export declare namespace FirebaseAuthTypes {
    ...
    interface AuthError extends NativeFirebaseError {
    ...
    type ActionCodeURL = ActionCodeURLClass;
    ...
    interface NativeFirebaseAuthError extends NativeFirebaseError {
        userInfo: {
            /**
    ...
    interface TotpMultiFactorGenerator {
         ...
         */
        generateSecret(session: FirebaseAuthTypes.MultiFactorSession, auth?: FirebaseAuthTypes.Module): Promise<TotpSecret>;
    }
     ...
     */
    type MultiFactorInfo = PhoneMultiFactorInfo | TotpMultiFactorInfo;
    interface PhoneMultiFactorInfo extends MultiFactorInfoCommon {
        factorId: 'phone';
        /**
    ...
    interface TotpMultiFactorInfo extends MultiFactorInfoCommon {
        factorId: 'totp';
    }
    interface MultiFactorInfoCommon {
        /**
     ...
     * ```
     */
    type getMultiFactorResolver = (auth: FirebaseAuthTypes.Module, error: unknown) => MultiFactorResolver | null;
    /**
     ...
     * Return the #{@link MultiFactorUser} instance for the current user.
     */
    type multiFactor = (auth: FirebaseAuthTypes.Module) => Promise<MultiFactorUser>;
    /**
     ...
     * ```
     */
    type AuthListenerCallback = (user: User | null) => void;
    /**
