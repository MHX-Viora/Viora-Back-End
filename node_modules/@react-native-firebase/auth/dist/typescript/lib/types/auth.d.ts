...
import type { AuthCredential, EmailAuthCredential, OAuthCredential, PhoneAuthCredential } from '../credentials';
...
export interface PhoneAuthListener {
    ...
    then(onFulfilled?: ((value: PhoneAuthSnapshot) => any) | null, onRejected?: ((error: ReactNativeFirebase.NativeFirebaseError) => any) | null): Promise<any>;
