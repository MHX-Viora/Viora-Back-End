...
namespace Viora.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260919025336_AddNativeAdvertisements")]
    partial class AddNativeAdvertisements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Viora.Domain.Entities.BankAccount", b =>
                {
                    ...
                    b.HasIndex("UserId", "AccountNumberHash")
                        .IsUnique();
            ...
            modelBuilder.Entity("Viora.Domain.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LedgerTransactionId")
                        .IsUnique()
                        .HasFilter("\"LedgerTransactionId\" IS NOT NULL");
            ...
            modelBuilder.Entity("Viora.Domain.Entities.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<long>("AnktCoinBalance")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Wallets", null, t =>
                        {
                            t.HasCheckConstraint("CK_Wallets_AnktCoinBalance", "\"AnktCoinBalance\" >= 0");

                            t.HasCheckConstraint("CK_Wallets_AvailableBalance", "\"AvailableBalance\" >= 0");

                            t.HasCheckConstraint("CK_Wallets_Currency", "char_length(\"Currency\") = 3");

                            t.HasCheckConstraint("CK_Wallets_HeldBalance", "\"HeldBalance\" >= 0");
                        });
                });

            modelBuilder.Entity("Viora.Domain.Entities.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WalletTransactions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_WalletTransactions_Balance", "\"BalanceBefore\" >= 0 AND \"BalanceAfter\" >= 0");

                            t.HasCheckConstraint("CK_WalletTransactions_Held", "\"HeldBefore\" >= 0 AND \"HeldAfter\" >= 0");
                        });
                });

            modelBuilder.Entity("Viora.Domain.Entities.Withdrawal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Withdrawals", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Withdrawals_Fee", "\"Fee\" >= 0 AND \"Fee\" < \"Amount\"");

                            t.HasCheckConstraint("CK_Withdrawals_NetAmount", "\"NetAmount\" = \"Amount\" - \"Fee\"");
                        });
                });
            ...
            modelBuilder.Entity("Viora.Domain.Entities.Payment", b =>
                {
                    b.HasOne("Viora.Domain.Entities.WalletTransaction", "LedgerTransaction")
                        .WithOne()
                        .HasForeignKey("Viora.Domain.Entities.Payment", "LedgerTransactionId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Viora.Domain.Entities.Wallet", "Wallet")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("Viora.Domain.Entities.Wallet", b =>
                {
                    b.HasOne("Viora.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Viora.Domain.Entities.Wallet", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Viora.Domain.Entities.Withdrawal", b =>
                {
                    b.HasOne("Viora.Domain.Entities.BankAccount", "BankAccount")
                    ...
                    b.HasOne("Viora.Domain.Entities.WalletTransaction", "LedgerTransaction")
                        .WithOne()
                        .HasForeignKey("Viora.Domain.Entities.Withdrawal", "LedgerTransactionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
